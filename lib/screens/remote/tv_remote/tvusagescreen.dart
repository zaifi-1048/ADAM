...
class _EnergyOverviewScreenState extends State<EnergyOverviewScreen> {
  ...
  // Simulated stats per range
  Map<String, Map<String, String>> get _stats => {
    'Today': {
      'time': '5h 20m',
      'energy': '3.8 kWh',
      'progress': '0.65',
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                const Icon(Icons.circle, color: cyan, size: 7),
                                const SizedBox(width: 6),
                                Text(
                                  'Part of your daily energy budget used by TV',
                                  style: GoogleFonts.inter(
                                    color: Colors.white38,
                                    fontSize: 10,
                                  ),
  ...
  Widget _deviceCard({
    ...
    child: Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: isOn ? color.withOpacity(0.1) : const Color(0xFF161B22),
