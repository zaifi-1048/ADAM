        ...
        () => Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Current language: $_selectedLanguageName",
                ...
                children: [
                  Expanded(
                    child: GestureDetector(
                      onTap: () async {
                        await _voiceCtrl.setMale();
                        await _voiceCtrl.applyVoiceSettings(
                          language: _ttsLanguage,
                        );
                        Navigator.pop(ctx);
                        await _voiceCtrl.tts.speak(
                          "Hello, I am ADAM your AI assistant.",
                        );
                      },
                      child: Container(
                        padding: const EdgeInsets.symmetric(vertical: 20),
                        decoration: BoxDecoration(
                          color: _voiceCtrl.isMaleVoice.value
                          ...
                          border: Border.all(
                            color: _voiceCtrl.isMaleVoice.value
                                ...
                                : Colors.white24,
                            width: _voiceCtrl.isMaleVoice.value ? 2 : 1,
                          ),
                        ),
                        child: Column(
                          children: [
                            ...
                            if (_voiceCtrl.isMaleVoice.value) ...[
                              const SizedBox(height: 8),
                              const Icon(
                                Icons.check_circle,
                          ...
                          () => GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color: _voiceCtrl.isMaleVoice.value
                                      ? const Color(0xFF4FD8EB).withOpacity(0.4)
